...
@IBDesignable class SetCardButton: BorderButton {
    ...
    var colors = [#colorLiteral(red: 1, green: 0.1491314173, blue: 0, alpha: 0), #colorLiteral(red: 0.5818830132, green: 0.2156915367, blue: 1, alpha: 1), #colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1)]
